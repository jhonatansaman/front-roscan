    ...
    async preencherGrafico(data, pos, data2) {
        ...
        if (pos == 1) {
            this.setState({
                ...
                arrayDataPre: [...state.arrayDataPre, Math.round(moment.duration(data).asHours(), 1)],
                arrayDataTotal: [...state.arrayDataTotal, Math.round(moment.duration(data2).asHours(), 1)],
            })
        }
        if (pos == 2) {
            this.setState({
